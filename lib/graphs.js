...
module.exports = ( function() {
	...
	Private.database.index.update = function( req ) {
				...
				var very_own_on_success = function( res2 ) {
					...
					if ( true === reindex ) {
						...
						if ( 'undefined' !== typeof res2.reference.index ) {
							...
							var generic_callback_2 = function( err2, result2 ) {
								console.log( "YYY DID OWN", typeof res2.reference, typeof res2, index, attr );
								if( 'undefined' !== typeof err2 && null !== err2 ) {
									own_on_error( err2 );
								} else {
							...
							console.log( "XXX DOING OWN", typeof res2.reference, typeof res2, index, attr );
							for ( var attr in data ) {
								if ( data.hasOwnProperty( attr ) ) {
							...
							console.log( "XXX NOT NOT NOT DOING OWN", id, typeof res2.reference, typeof res2, index, attr );
		...
		var own_on_error = function( res ) {
			...
			console.log("GETTTTING ", type, index, key, value );
		if ( 'relationship' === type ) {
