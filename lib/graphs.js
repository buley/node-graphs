			...
			if( 'undefined' !== typeof err && null !== err ) {
				...
				var generic_callback_2 = function( err2, result2 ) {
					if( 'undefined' !== typeof err2 && null !== err2 ) {
						...
						own_on_success( { id: result2.id, data: result2.data, start: { id: result2.start.id, data: result2.start.data }, end: { id: result2.end.id, data: result2.end.data }, type: result2.type } );
					}
				};
