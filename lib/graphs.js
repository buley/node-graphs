			...
			if( 'undefined' !== typeof err && null !== err ) {
				...
				var generic_callback_2 = function( err2, result2 ) {
					...
					if( 'undefined' !== typeof err2 && null !== err2 ) {
						...
						console.log( { id: result.id, data: result.data, start: { id: result.start.id, data: result.start.data }, end: { id: result.end.id, data: result.end.data } } );
						own_on_success( { id: result.id, data: result.data, start: { id: result.start.id, data: result.start.data }, end: { id: result.end.id, data: result.end.data } } );
