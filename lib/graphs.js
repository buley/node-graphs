...
/*
							var generic_callback_3 = function( err2, result2 ) {
								console.log( 'Private.database.index.update > generic_callback_3 > err2, result2', err2, result2 );
							};
							console.log("ENTERING"+ JSON.stringify( data ) );
							for ( var attr in data ) {
								if ( data.hasOwnProperty( attr ) ) {
									console.log( "DOING INDEX!", index, attr, typeof res2.reference.index );
									res2.reference.index( index, attr, data[ attr ], generic_callback_3, false );
								}
							}
*/
console.log("HOUSTON");
