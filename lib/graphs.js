	...
	Private.database.node.destroy = function( req ) {
		...
		var generic_callback = function( err, result ) {
			...
			if( 'undefined' !== typeof err && null !== err ) {
				...
				console.log("THIS IS MY DOING DELETE", err2, typeof result2);
					own_on_success();
				}
				console.log("DOING DELETE", typeof result.delete);
				var res = result.del( own_generic_callback, true );
				console.log("DID DELETE",typeof res, res );
			}
		};
