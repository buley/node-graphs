						...
						if ( 'undefined' !== typeof res2.reference.index ) {
							...
							var generic_callback_2 = function( err2, result2 ) {
								...
								if( 'undefined' !== typeof err2 && null !== err2 ) {
									...
									var del_callback = function( err3, res3 ) {
			
										res2.reference.index( index, key, value, function(res2) { console.log("DUMB CALLBACK",res2); 
											...
											if ( null !== result2 ) {
												...
												if ( type === 'relationship' ) {
													if ( 'undefined' !== typeof res2.start ) {
														obj.start = res2.start.id;
													}
													if ( 'undefined' !== typeof res2.end ) {
														obj.end = res2.end.id;
													}
												}
