...
module.exports = ( function() {
	...
	Private.index.update = function( req ) {
		...
		var idx_callback = function( req1, res1 ) {
			...
			Private.log( 'Private.index.update > idx_callback() > pre-flight > reindex, typeof own_on_success and own_on_error', reindex, typeof own_on_success, typeof own_on_error );
