		...
		var generic_callback = function( err, result ) {
			...
			if( 'undefined' !== typeof err && null !== err ) {
				...
				var generic_callback_2 = function( err2, result2 ) {
					console.log("FRIENDLINESS", result2, result );
					if( 'undefined' !== typeof err2 && null !== err2 ) {
						console.log("BEAVER ERROR");	
						own_on_error( err2 );
						...
						console.log("BEAVER sUCCESS", obj, "GIRL");	
						own_on_success( obj );

					}
				};
				console.log("VERSEEEEE",data);
				console.log("VERSE RESULT",typeof result.index, result);
