...
/*						if ( 'undefined' !== typeof res2.reference.index ) {
							...
							var generic_callback_2 = function( err2, result2 ) {
								...
								if( 'undefined' !== typeof err2 && null !== err2 ) {
									...
									var del_callback = function( err3, res3 ) {
										...
										res2.reference.index( index, key, value, function(err4, res4) {
		
											Private.log("res2.reference.index err4,res4",err4,res4); 
									...
									//TODO: Do we need to delete the previous index before smashing in a new one?
									del_callback( null, null );//async?
							...
							for ( var attr in data ) {
								if ( data.hasOwnProperty( attr ) ) {
									Private.log( "DOING INDEX!", index, attr, typeof res2.reference.index );
	...
	Private.node.create = function( req ) {
			...
			if ( Array.isArray( req.data ) && ( 'undefined' === type key || 'undefined' === typeof value || null === key || null === value ) ) {
