					...
					if ( false !== reindex ) {
						...
						for ( var attr in data ) {
							if ( data.hasOwnProperty( attr ) ) {
								...
								Private.log('Private.database.index.update > doing del_on_success()' );
								del_on_success( function(err3,res3) {
									Private.log('Private.database.index.update > doing Private.database.index.create()' );
