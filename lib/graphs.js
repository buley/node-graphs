...
module.exports = ( function() {
	...
	Private.database.index.create = function( req ) {
		...
		var generic_callback = function( err, result ) {
			console.log( 'Private.database.index.create > generic_callback', err, result );
			if( 'undefined' !== typeof err && null !== err ) {
				own_on_error( err );
			} else {				
				var generic_callback_2 = function( err2, result2 ) {
					console.log( 'Private.database.index.create > generic_callback_2', err2, result2 );
					if( 'undefined' !== typeof err2 && null !== err2 ) {
						own_on_error( err2 );
					} else {
						var obj = {};
						...
						console.log( 'Private.database.index.create > generic_callback_2 > own_on_success()', obj );
						own_on_success( obj );
					}
				};
				console.log( 'Private.database.index.create > generic_callback > result.index()', index, key, value );
